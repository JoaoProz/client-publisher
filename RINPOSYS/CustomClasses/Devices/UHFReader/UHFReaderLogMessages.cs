...
{
    /// <summary>
    /// Returns log messages from cmdRet code
    /// </summary>
    public static class UHFReaderLogMessages
    {
        #region cmdRet code descriptions

        /// <summary>
        /// Transforms cmdRet code into string description and returns it
        /// </summary>
        /// <param name="cmdRet"></param>
        /// <returns>
        /// Returns a string description of cmdRet
        /// </returns>
        ...
        #region cmdRet error code descriptions

        /// <summary>
        /// Transforms cmdRet code into string error description and returns it
        /// </summary>
        /// <param name="cmdRet"></param>
        /// <returns>
        /// Returns a string error description of cmdRet
        /// </returns>
