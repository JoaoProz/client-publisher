...
{
    /// <summary>
    /// Contains all DLL methods contained in UHFReader86.dll
    /// </summary>
    public static class RWDev
    {
        private const string DLLNAME = @"C:\ProgramData\RINPOSYS\UHFReader86.dll";
        ...
        [DllImport(DLLNAME, CallingConvention = CallingConvention.StdCall)]
        public static extern int GetReaderInformation(ref byte ComAdr,              //Reader address
                                                      byte[] VersionInfo,           //Software version
                                                      ref byte ReaderType,              //Reader model
                                                      ref byte TrType,      //Supported protocols
                                                      ref byte dmaxfre,           //The highest frequency used by the current reader
								                      ref byte dminfre,           //The lowest frequency used by the current reader
								                      ref byte powerdBm,             //Reader output power
                                                      ref byte ScanTime,
								                      ref byte Ant,
								                      ref byte BeepEn,
								                      ref byte OutputRep,
